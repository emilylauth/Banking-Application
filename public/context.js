      ...
      <div className={classes()} style={{ maxWidth: "18rem" }}>
        ...
        <div className="card-body">
          ...
          {props.handle && show ? (
            ...
            props.submitButton && (
              <>
                <div className="card border-secondary mb-3 text-center card-body text-secondary">
                  <h5>Success</h5>
                </div>
                <Link to="/account">
          ...
          {props.deposit && show ? (
            ...
            props.submitButtonDeposit && (
              <>
                <div className="card border-dark mb-3 text-center card-body text-dark">
